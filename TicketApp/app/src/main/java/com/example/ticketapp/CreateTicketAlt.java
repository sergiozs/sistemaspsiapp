    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_create_ticket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String ticketid = "tk.id"+datecode;
                Date time_begin = new Date();
                String created_by = FBuser.getDisplayName();
                String user = (ct_user).getText().toString();
                String floor = ((EditText)findViewById(R.id.ct_floor)).getText().toString();
                String type = ((Spinner)findViewById(R.id.ct_type)).getSelectedItem().toString();
